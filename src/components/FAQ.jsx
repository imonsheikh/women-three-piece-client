  ...
  const faqs = [
    {
      ...
      answer:
        "আমাদের 3 পিস সেটগুলো 100% কটন বা হালকা পলিয়েস্টার মিশ্রিত ফ্যাব্রিকে তৈরি। আরামদায়ক এবং দৈনন্দিন ব্যবহারের জন্য উপযুক্ত।",
      category: "Material",
    ...
    {
      question: "এই 3 পিস পোশাকের মাপ কেমন?",
      answer:
        "আমাদের সব 3 পিস সেট স্ট্যান্ডার্ড সাইজে আসে। সাইজ চার্ট দেখুন প্রতিটি পণ্যের পেজে।",
      category: "Material",
      icon: <FaTshirt className="text-blue-500" />,
    },
    {
